    ...
    html = f"""
            ...
            <html>
                <body style="max-width: max-content; margin: auto; text-align: center; font-family: Verdana">
                    ...
                    <form action="./advanced_measure" style="display: inline-block">
                        <input type="submit" value="Advanced measure" style="font-size: 16px; margin: 4px 2px; cursor: pointer; background-color: #04AA6D; border: none; color: white; padding: 15px 32px"/>
                    </form>
